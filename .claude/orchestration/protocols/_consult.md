...
independent is left, a producing session parks for it (`.claude/orchestration/v2.py park answer`: another worker
produces meanwhile, and you are resumed when the answer has come and the producing slot is free); any other ends its
