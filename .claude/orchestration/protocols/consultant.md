...
Answer from what you hold; look up only what the answer needs (a gather: `.claude/orchestration/v2.py step
{QID} 1 SOURCE...`). Answer precisely enough that {ASKER} can continue without asking again: what is decided and where
