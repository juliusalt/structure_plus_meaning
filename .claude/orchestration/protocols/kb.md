...
forked from you (the planner, and consultations answering the other roles' questions) start knowing it.
...
Then reply INTEGRATED and end your turn. Later you are resumed with a planner's notes (decisions and
