...
F3 #695; R5f1 #734, R5f2 #736 and V2b's (3) #738; the design #730, the fixes #731
...
- **The entries**: #378 (`cbf0c7e9`), #376 (`47a67cfe`), #381 (`2d97747c`), #383 (`7b23938c`), #428 (`631429e6`, the
  ...
  builds R5f1 and R5f2; the planner's answers to its questions in `.build/tasks/725/verdict.md`).
...
- **R5d's first part** (#595, `e46ed1a6`): the view vocabulary in `Factor_Resolution_Commitments`
  ...
  `view_match_pair_some`), the dead free sockets of #601's, #603's and #607's records dropped.
...
- **What the next events ask**: #730's decision, its builds to place (then #733 briefs); #731 and #732; #726's landing before
...
- **Mailed, read by each task's first session** (open tasks only): #540 — q110, #506's 1 and 7, q105 (the barred
  ...
  1); #730 — review 726's 2; #731 — review 726's 3 (next-edits 275); #734 — review 726's 5.
