theory Cached_Graft_Execution
  imports Cached_Graft_Presentation Finite_Term_Object_Words RRA_Cached_Graft_Investigation Factor_Executable_Artifact_Values Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term cached_graft_investigation}\<close>

export_code cached_graft_report_value cached_graft_report_selections finite_term_shared_word_fold cached_graft_packet cached_graft_indices cached_graft_inspect digit_allocated_view
