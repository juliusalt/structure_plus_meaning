theory Certified_Cause_Execution
  imports Certified_Cause_Presentation Finite_Term_Word_Streaming Factor_Certified_Cause_Investigation Factor_Executable_Environment_Values Factor_Finite_Judgment_Reading_Sharing Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term certified_cause_investigation}\<close>

export_code certified_cause_report_value certified_cause_report_selections finite_term_shared_word_fold certified_cause_packet certified_cause_indices decision_row_inspect decision_family_inspect
