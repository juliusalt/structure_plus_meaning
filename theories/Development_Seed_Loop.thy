...
definition development_seed_loop_data :: "development_seed_loop_report \<Rightarrow> finite_factor_term option" where
  "development_seed_loop_data=finite_partial_pair
    ...
    (finite_partial_pair (Some \<circ> finite_option_presentation finite_development_context_value)
      (finite_partial_pair (finite_partial_option
          (development_problems_data state_constant_key development_seed_inert (\<lambda>_. None) (\<lambda>_. None)))
        (development_requests_data state_constant_key development_seed_inert (\<lambda>_. None) (\<lambda>_. None))))"

lemma development_seed_loop_data_presented:
  ...
  shows "finite_presented_on development_seed_loop_data (UNIV\<times>UNIV\<times>{x. set_option x\<subseteq>lists P}\<times>lists R)"
  ...
  by (intro finite_partial_pair_presented finite_presented_total finite_sequence_presentation_injective
    ...
    development_problems_data_presented development_requests_data_presented domain requests)

definition development_seed_loop_value :: "development_problem fset \<Rightarrow> finite_factor_term" where
  "development_seed_loop_value answered=finite_store_option id
