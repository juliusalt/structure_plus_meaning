theory Digit_Allocation_Execution
  imports Digit_Allocation_Presentation Finite_Term_Object_Words RRA_Digit_Allocation_Investigation Factor_Executable_Artifact_Values Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term digit_allocation_investigation}\<close>

export_code digit_allocation_report_value digit_allocation_report_selections finite_term_shared_word_fold digit_allocation_packet digit_allocation_indices digit_allocation_inspect
