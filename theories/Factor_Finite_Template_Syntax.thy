...
lemma finite_pattern_forest_bindings_exact:
  ...
  by (simp add: finite_pattern_forest_bindings_def finite_syntax_forest_table_def pattern_forest_bindings_def placed_table_values comp_def
...
text \<open>
  ...
  syntax through the executable bound forest, its literal and callee tables as the executable syntax
  forest table of the premises' tables.
\<close>
...
definition finite_premise_forest_literals :: "('a,'u) finite_premise_template list \<Rightarrow> (local_address\<times>finite_exact_artifact) fset" where
  "finite_premise_forest_literals ts=finite_syntax_forest_table (map finite_template_literals ts)"
...
lemma finite_premise_forest_literals_exact [simp]:
  ...
  by (simp add: finite_premise_forest_literals_def finite_syntax_forest_table_def premise_forest_literals_def
    placed_table_values comp_def)
...
definition finite_premise_forest_callees :: "('a,'u) finite_premise_template list \<Rightarrow> (local_address\<times>'u definition_site) fset" where
  "finite_premise_forest_callees ts=finite_syntax_forest_table (map finite_template_callees ts)"
...
lemma finite_premise_forest_callees_exact [simp]:
  ...
  by (simp add: finite_premise_forest_callees_def finite_syntax_forest_table_def premise_forest_callees_def comp_def)
