...
proof -
  ...
  qed
  have finite: "finite ?D" using system_definitions_finite[OF native_package_system_formed[OF package]] by simp
  ...
  proof (rule native_definition_family_selectable[OF installed(1) finite])
