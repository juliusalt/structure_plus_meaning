theory Generation_Record_Execution
  imports Generation_Record_Presentation Finite_Term_Object_Words RRA_Generation_Record_Investigation Factor_Executable_Environment_Values Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term generation_record_investigation}\<close>

export_code generation_record_report_value generation_record_report_selections finite_term_shared_word_fold generation_record_packet generation_record_indices generation_record_inspect
