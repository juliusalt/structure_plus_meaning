theory Graft_Admission_Execution
  imports Graft_Admission_Presentation Finite_Term_Object_Words RRA_Graft_Admission_Investigation Factor_Executable_Artifact_Values Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term graft_admission_investigation}\<close>

export_code graft_admission_report_value graft_admission_report_selections finite_term_shared_word_fold graft_admission_packet graft_admission_indices graft_admission_inspect graft_admission_requirements
