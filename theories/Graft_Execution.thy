theory Graft_Execution
  imports Graft_Presentation Finite_Term_Object_Words RRA_Graft_Investigation Factor_Executable_Artifact_Values Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term graft_investigation}\<close>

export_code graft_report_value graft_report_selections finite_term_shared_word_fold graft_packet graft_indices graft_inspect graft_view_formed use_word_length
