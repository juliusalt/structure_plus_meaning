theory Native_Certificate_Investigation_Execution
  imports Finite_Term_Word_Streaming Native_Certificate_Presentation Factor_Native_Certificate_Investigation Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term native_certificate_investigation}\<close>

export_code native_certificate_report_value native_certificate_report_selections finite_term_shared_word_fold native_certificate_indices native_certificate_report_packet native_certificate_inspect
