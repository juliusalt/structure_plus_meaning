theory Native_Certificate_Replay_Execution
  imports Parallel_Replay_Readers Native_Replay_Presentation Finite_Term_Word_Streaming Factor_Native_Replay_Investigation Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term native_replay_investigation}\<close>

export_code native_replay_report_value native_replay_report_selections finite_term_shared_word_fold native_replay_packet native_replay_indices native_replay_inspect native_replay_family_inspect
