theory Native_Derivation_Investigation_Execution
  imports Finite_Term_Word_Streaming Native_Derivation_Presentation Factor_Native_Derivation_Reports Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term native_derivation_investigation}\<close>

export_code native_derivation_report_value native_derivation_report_selections finite_term_shared_word_fold native_derivation_report_packet native_derivation_indices native_derivation_report native_derivation_assess native_derivation_assess_report
