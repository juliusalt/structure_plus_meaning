theory Native_Development_Steering
  imports Factor_Steered_Execution_Sharing Native_Development_Execution Native_Execution_Refinements Development_Presentation
begin

setup \<open>Finite_Observation_Contracts.export @{term development_subject_investigation}\<close>

export_code native_steered_development native_steering_report_value development_empty_questions
  development_first_questions finite_term_shared_word_fold development_steering_choice steered_development_result
