theory Native_Graph_Investigation_Execution
  imports Finite_Term_Word_Streaming Native_Graph_Presentation Factor_Native_Graph_Investigation Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term native_graph_investigation}\<close>

export_code native_graph_report_value native_graph_report_selections finite_term_shared_word_fold native_graph_indices native_graph_report_packet native_graph_inspect native_graph_input_inspection
  ...
  in Eval module_name Native_Graph_Investigation_Execution file_prefix native_graph_investigation
