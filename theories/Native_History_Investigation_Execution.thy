theory Native_History_Investigation_Execution
  imports Factor_Native_History_Reports Native_Execution_Refinements Native_History_Presentation
begin

setup \<open>Finite_Observation_Contracts.export @{term native_history_investigation}\<close>

export_code native_history_report_value native_history_report_selections finite_term_shared_word_fold
  native_history_report_packet native_history_indices native_history_report native_history_assess native_history_assess_report
