...
text \<open>
  The executable forest is the executable placed forest at the syntax branches: it reads each child
  with its index through the placed forest's code equation.
\<close>

definition finite_syntax_forest :: "finite_exact_artifact list \<Rightarrow> finite_exact_artifact" where
  "finite_syntax_forest Rs=finite_placed_forest syntax_branch Rs"
