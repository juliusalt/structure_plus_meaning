theory Shared_Digit_Replay_Execution
  imports Factor_Digit_Replay_Investigation Factor_Executable_Environment_Values
    Factor_Finite_Judgment_Reading_Sharing Factor_Digit_Replay_Reading_Sharing Factor_Structural_Replay_Identity RRA_Generation_Child_Row_Images Finite_Investigation_Execution_Sharing Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term digit_replay_investigation}\<close>

export_code digit_replay_packet digit_replay_indices digit_replay_inspect digit_replay_family_inspect
