theory Use_Allocation_Execution
  imports Use_Allocation_Presentation Finite_Term_Object_Words RRA_Use_Allocation_Investigation Native_Execution_Refinements
begin

setup \<open>Finite_Observation_Contracts.export @{term use_allocation_investigation}\<close>

export_code use_allocation_report_value use_allocation_report_selections finite_term_shared_word_fold use_allocation_packet use_allocation_indices use_allocation_inspect use_word_length
