...
RECIPE = Recipe(
    ...
    groups=((
        Execution('presentation', 'check_presented_report.py', ('--project', '{project}', '--theory', 'Native_Certificate_Input_Execution', '--module', 'Native_Certificate_Input_Execution', '--report', 'native_certificate_input_report_value', '--scope', 'native_certificate_input_indices', '--selections', 'native_certificate_input_report_selections', '--workers', '4', '--timeout', '1200'), 1300),
    ),),
