...
RECIPE = Recipe(
    ...
    groups=((Execution('presentation', 'check_presented_report.py', ('--project', '{project}', '--theory', 'Certified_Cause_Execution', '--module', 'Certified_Cause_Execution', '--report', 'certified_cause_report_value', '--scope', 'certified_cause_indices', '--selections', 'certified_cause_report_selections', '--workers', '4', '--timeout', '1200'), 1300),),),
