...
RECIPE = Recipe(
    ...
    roots=('Concurrent_Replay_Execution',),
    export='Concurrent_Replay_Execution:concurrent_replay.ML',
    session='Reconstruct_Concurrent_Replay',
    groups=((Execution('presentation', 'check_presented_report.py', ('--project', '{project}', '--theory', 'Concurrent_Replay_Execution', '--module', 'Digit_Replay_Execution', '--report', 'concurrent_replay_report_value', '--scope', 'digit_replay_indices', '--selections', 'concurrent_replay_report_selections', '--workers', '4', '--timeout', '1200'), 1300),),),
