...
RECIPE = Recipe(
    ...
    groups=((Execution('presentation', 'check_presented_report.py', ('--project', '{project}', '--theory', 'Known_History_Execution', '--module', 'Digit_History_Execution', '--report', 'known_history_report_value', '--scope', 'digit_history_indices', '--selections', 'known_history_report_selections'), 10800),),),
