...
RECIPE = Recipe(
    ...
    groups=((Execution("comparison", 'check_native_certificate_replay.py', ("--project", "{project}"), 2100),
        Execution('presentation', 'check_presented_report.py', ('--project', '{project}', '--theory', 'Native_Certificate_Replay_Execution', '--module', 'Native_Certificate_Replay_Execution', '--report', 'native_replay_report_value', '--scope', 'native_replay_indices', '--selections', 'native_replay_report_selections', '--workers', '4', '--timeout', '1200'), 1300),),),
