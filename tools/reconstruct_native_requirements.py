...
RECIPE = Recipe(
    ...
    groups=((Execution("comparison", "check_native_requirement_investigation.py",
    ...
    boundary=("A run without --proof reconstructs the complete contracts from HOL. The actual source "
              ...
              "every goal occurrence and a final conjunction before compiling their complete source extension. Computed "
              "observations compare the original same-term conjunction, every retained artifact and outgoing binding, "
