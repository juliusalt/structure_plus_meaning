...
RECIPE = Recipe(
    ...
    groups=((Execution('presentation', 'check_presented_report.py', ('--project', '{project}', '--theory', 'Quoted_History_Execution', '--module', 'Digit_History_Execution', '--report', 'quoted_history_report_value', '--scope', 'digit_history_indices', '--selections', 'quoted_history_report_selections'), 10800),),),
