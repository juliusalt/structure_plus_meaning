...
RECIPE = Recipe(
    ...
    groups=((Execution('presentation', 'check_presented_report.py', ('--project', '{project}', '--theory', 'Requirement_Decision_Execution', '--module', 'Requirement_Decision_Execution', '--report', 'requirement_decision_report_value', '--scope', 'requirement_decision_indices', '--selections', 'requirement_decision_report_selections', '--workers', '4', '--timeout', '1200'), 1300),),),
