...
[executed native extension recipe](native-extensions.md), and
[source-checking extension recipe](native-sources.md) use the same reconstruction
...
fixtures and report comparison. The same collector serves all five boundaries.
